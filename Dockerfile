...
COPY packages/sysdom-canon-mcp/package.json packages/sysdom-canon-mcp/
...
RUN npm install --global --omit=dev @anthropic-ai/claude-code@2.1.210 @openai/codex@0.144.4 opencode-ai@1.18.2 @google/gemini-cli@0.50.0 \
  && apt-get update \
