...
const DEFAULT_FAVICON_LINKS = [
  '<link rel="icon" href="/favicon.svg?v=20260804" type="image/svg+xml" />',
  '<link rel="icon" href="/favicon.ico?v=20260804" sizes="48x48" />',
  '<link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png?v=20260804" />',
  '<link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png?v=20260804" />',
].join("\n");
