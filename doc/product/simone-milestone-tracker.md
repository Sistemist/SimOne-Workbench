...
| Model routing and auditability | 36% | `model_route_decisions` ledger, lane vocabulary, local context compression envelope, output confidence/review fields | Real provider execution, route/run/cost linking, review UI, evaluations |
