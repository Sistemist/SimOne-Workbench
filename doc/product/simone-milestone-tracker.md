...
| Model routing and auditability | 38% | `model_route_decisions` ledger, lane vocabulary, local context compression envelope, output confidence/review fields, cost-event route links | Real provider execution, run/output artifact linking, review UI, evaluations |
