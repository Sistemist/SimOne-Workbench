...
| Model routing and auditability | 43% | `model_route_decisions` ledger, lane vocabulary, local context compression envelope, output confidence/review fields, cost-event route links, settings audit page with review filters/actions | Real provider execution, run/output artifact linking, evaluations |
