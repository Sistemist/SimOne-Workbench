...
| Sprint Zero Brief carries into SIM Starter, first-map review, and bounded child tasks | `ui/src/components/OnboardingWizard.tsx`, `ui/src/components/OnboardingWizard.simone-starter.test.tsx`, `ui/src/components/SimOneSprintZeroGuide.tsx`, `ui/src/components/SimOneSprintZeroGuide.test.tsx`, `ui/src/pages/IssueDetail.tsx`, `ui/src/pages/IssueDetail.test.tsx` | Implemented and tested | Persist selected reviewed map content directly into SIM Wiki/artifact records |
