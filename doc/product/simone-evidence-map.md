...
| Shareable Venture Architecture Map exists | `ui/src/pages/Artifacts.tsx`, `ui/src/pages/VentureShare.tsx`, related tests, PRD | Implemented and tested | Richer share previews and proof context |
...
| Shareable venture artifacts | `SYS-199` | Shareable Venture Architecture Map exists; richer previews remain |
