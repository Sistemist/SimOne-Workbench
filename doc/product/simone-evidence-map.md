...
| Sprint Zero Brief carries into SIM Starter and first-map review | `ui/src/components/OnboardingWizard.tsx`, `ui/src/components/OnboardingWizard.simone-starter.test.tsx`, `ui/src/components/SimOneSprintZeroGuide.tsx`, `ui/src/components/SimOneSprintZeroGuide.test.tsx`, `ui/src/pages/IssueDetail.test.tsx` | Implemented and tested | Add approval/promotion actions after review |
