...
| Public Systems Bottleneck Scanner includes lived examples, signal strength, safe diagnosis signals, and handoffs to Coach and Starter | `ui/src/components/FrontDoor.tsx`, `ui/src/pages/SystemsBottleneckScanner.tsx`, `ui/src/pages/SystemsBottleneckScanner.test.tsx`, `ui/src/pages/SimCoach.tsx`, `ui/src/components/OnboardingWizard.tsx`, scanner-related tests, PRD | Implemented and tested | Calibrate scoring against real submissions without exposing private notes |
...
| Public Systems Bottleneck Scanner | `SYS-200` | Scanner, lived examples, signal strength, secondary engine watch, safe diagnosis signals, and Sprint Zero handoff exist; real-submission calibration remains |
