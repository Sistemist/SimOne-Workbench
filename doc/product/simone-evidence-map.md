...
| Public Systems Bottleneck Scanner | `SYS-200` | Scanner, lived examples, safe diagnosis signals, and Sprint Zero handoff exist; scoring nuance remains |
