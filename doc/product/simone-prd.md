...
- The public Systems Bottleneck Scanner produces a safe share summary containing
  ...
  curious user can try the tool without inventing a perfect prompt. After a
...
- Make public scanner and share artifacts feel like coherent SimOne outputs.
  ...
  The scanner now exposes lived example notes, safe diagnosis signals, a safe
  share summary, and a scanner-to-SIM-Coach and scanner-to-SIM-Starter handoff
  after sign-in. The scanner also produces the first structured Sprint Zero
  Brief and carries it into the protected Starter task.
