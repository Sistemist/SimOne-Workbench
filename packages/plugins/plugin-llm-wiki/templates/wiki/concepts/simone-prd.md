...
- public scanner, scanner-to-Coach, and shareable artifact beginnings
...
public scanner results, scanner-to-Coach handoff, share artifacts, and Coach
explanations should feel like native SimOne surfaces.
