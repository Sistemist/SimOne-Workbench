...
export const DEFAULT_SIMONE_WORKBENCH_FIELD_GUIDE = templateFile("wiki/concepts/simone-workbench-field-guide.md");
export const DEFAULT_SIMONE_EVIDENCE_MAP = templateFile("wiki/concepts/simone-evidence-map.md");
...
export const BOOTSTRAP_FILES: ReadonlyArray<{ path: string; contents: string }> = [
  ...
  { path: "wiki/concepts/simone-workbench-field-guide.md", contents: DEFAULT_SIMONE_WORKBENCH_FIELD_GUIDE },
  { path: "wiki/concepts/simone-evidence-map.md", contents: DEFAULT_SIMONE_EVIDENCE_MAP },
