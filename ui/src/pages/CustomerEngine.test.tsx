...
describe("CustomerEngine", () => {
  ...
  it("renders live read-only Customer Engine bridge data", async () => {
    ...
    expect(text).toContain("Customer Signal");
    expect(text).toContain("Live signal from Tissuu");
    ...
    expect(text).toContain("Read-only bridge");
    expect(text).toContain("Customer signal");
    expect(text).toContain("Next judgment");
    ...
    expect(text).toContain("Today's Signal");
    expect(text).toContain("Next Judgment");
